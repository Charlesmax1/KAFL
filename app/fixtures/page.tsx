        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              The official match schedule for the 2026 KAFL season.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-600 text-lg mb-6">
              The 2026 season schedule is currently being finalized. 
              Check back soon for match dates, venues, and times.
            </p>
            ...
            <p className="text-xs text-gray-400 mt-6">
              🔔 Subscribe to our newsletter for fixture announcements
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center bg-gradient-to-r from-federation-green to-federation-dark rounded-xl p-8">
            ...
            <p className="text-white/80 text-sm max-w-md mx-auto mb-4">
              Be among the first to secure your spot at the inaugural KAFL season matches.
            </p>
            <Link
              href="/contact"
              className="inline-block bg-federation-gold text-federation-dark px-6 py-2.5 rounded-lg font-semibold hover:bg-yellow-500 transition-colors"
            >
              Get Notified
            </Link>
          </div>
